...
if [[ ${zinsults_load[(r)sudo]} == sudo ]];then
	msgs+=(
		...
		"BOB says:  You seem to have forgotten your command, enter another!" # s/passwd/command/
...
### SHAKESPEARE INSULTS ###
if [[ ${zinsults_load[(r)shakespeare]} == shakespeare ]];then
	msgs+=(
...
if [[ ${zinsults_load[(r)martin_luther]} == martin_luther ]];then
	msgs+=(
